...
export class CreateAttendanceGroups1779830000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "attendance_groups" ("id" SERIAL NOT NULL, "programme_semester_id" integer NOT NULL, "name" character varying(64) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_att_groups_ps_name" UNIQUE ("programme_semester_id", "name"), CONSTRAINT "PK_att_groups_id" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "attendance_group_students" DROP CONSTRAINT "FK_att_group_students_student_id"`);
        await queryRunner.query(`ALTER TABLE "attendance_group_students" DROP CONSTRAINT "FK_att_group_students_group_id"`);
        await queryRunner.query(`ALTER TABLE "attendance_groups" DROP CONSTRAINT "FK_att_groups_programme_semester_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_att_group_students_student_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_att_group_students_group_id"`);
