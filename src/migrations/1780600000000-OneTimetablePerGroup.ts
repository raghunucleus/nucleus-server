...
export class OneTimetablePerGroup1780600000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "timetables" DROP COLUMN "effective_from"`);
        await queryRunner.query(`ALTER TABLE "timetables" DROP COLUMN "effective_to"`);
        await queryRunner.query(`ALTER TABLE "timetables" DROP COLUMN "status"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "timetables" ADD "status" character varying(16) NOT NULL DEFAULT 'draft'`);
        ...
        await queryRunner.query(`ALTER TABLE "timetables" ADD "effective_from" date NOT NULL DEFAULT CURRENT_DATE`);
        await queryRunner.query(`ALTER TABLE "timetables" ALTER COLUMN "effective_from" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "timetables" DROP CONSTRAINT "UQ_timetables_ps_group"`);
    }
