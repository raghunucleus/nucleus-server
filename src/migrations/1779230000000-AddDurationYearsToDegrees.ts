...
export class AddDurationYearsToDegrees1779230000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "degrees" ADD "duration_years" integer NOT NULL DEFAULT 1`,
    );
    await queryRunner.query(
      `ALTER TABLE "degrees" ALTER COLUMN "duration_years" DROP DEFAULT`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "degrees" DROP COLUMN "duration_years"`,
    );
  }
}
