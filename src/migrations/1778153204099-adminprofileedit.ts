...
export class Adminprofileedit1778153204099 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "admins" ADD "first_name" character varying(64)`,
    );
    await queryRunner.query(
      `ALTER TABLE "admins" ADD "last_name" character varying(64)`,
    );
    await queryRunner.query(
      `ALTER TABLE "admins" ADD "mobile_number" character varying(32)`,
    );
    await queryRunner.query(
      `ALTER TABLE "admins" ADD "display_name" character varying(129)`,
    );
  }
