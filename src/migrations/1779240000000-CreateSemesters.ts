...
export class CreateSemesters1779240000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "semesters" ("id" SERIAL NOT NULL, "sem_number" integer NOT NULL, "code" character varying(16) NOT NULL, "name" character varying(64) NOT NULL, "year_sem_format" character varying(16) NOT NULL, "roman_format" character varying(8) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_semesters_sem_number" UNIQUE ("sem_number"), CONSTRAINT "UQ_semesters_code" UNIQUE ("code"), CONSTRAINT "PK_semesters_id" PRIMARY KEY ("id"))`,
    );
