...
export class AddSubjectTypeToSubjects1779920000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "subjects" ADD COLUMN "subject_type_id" integer`);
        ...
        // 3. Now lock it down.
        await queryRunner.query(`ALTER TABLE "subjects" ALTER COLUMN "subject_type_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "subjects" ADD CONSTRAINT "FK_subjects_subject_type_id" FOREIGN KEY ("subject_type_id") REFERENCES "subject_types"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "subjects" DROP CONSTRAINT "FK_subjects_subject_type_id"`);
        await queryRunner.query(`ALTER TABLE "subjects" DROP COLUMN "subject_type_id"`);
    }
